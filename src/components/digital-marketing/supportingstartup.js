      ...
      <Row justify="center" gutter={[32, 32]} align="middle" style={{ marginBottom: "80px" }}>
        ...
        <Col xs={24} sm={24} md={12} lg={12} xl={12}>
          <div className={styles.contentWrapper}>
            <span className={styless.heroBadge}>
              How We Work
            </span>
            <h2 className={styless.provenTextDigital} style={{ fontSize: "32px", marginBottom: "15px", lineHeight: "1.3" }}>
              Supporting Startups at Every Stage of the Growth Curve
            </h2>
            <div className={styless.allTextDigital} style={{ marginBottom: "20px" }}>
              <p>
            ...
            <h3 className={styless.provenTextDigital} style={{ fontSize: "20px", marginBottom: "20px" }}>
              How It Works
            </h3>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <h4 className={styless.provenTextDigital} style={{ fontSize: "18px", margin: "4px 0 8px 0" }}>Audit and Strategy</h4>
                  <p className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.5", margin: 0 }}>
              ...
              <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <h4 className={styless.provenTextDigital} style={{ fontSize: "18px", margin: "4px 0 8px 0" }}>Execute and Optimize</h4>
                  <p className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.5", margin: 0 }}>
              ...
              <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <h4 className={styless.provenTextDigital} style={{ fontSize: "18px", margin: "4px 0 8px 0" }}>Scale and Report</h4>
                  <p className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.5", margin: 0 }}>
      ...
      <Row justify="center" gutter={[32, 32]} align="middle">
        <Col xs={24} sm={24} md={12} lg={12} xl={12}>
          <div className={styles.contentWrapper}>
            ...
            <div className={styless.allTextDigital} style={{ marginBottom: "25px" }}>
              <p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "30px" }}>
              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                ...
                <span className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.4" }}>No agency-speak or vanity metric reports</span>
              </div>
              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                <FaCheckCircle style={{ color: "#f97316", marginTop: "4px", minWidth: "16px" }} />
                <span className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.4" }}>Real humans who answer your calls and emails</span>
              </div>
              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                <FaCheckCircle style={{ color: "#f97316", marginTop: "4px", minWidth: "16px" }} />
                <span className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.4" }}>Strategy built on data, not guesswork</span>
              </div>
              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                <FaCheckCircle style={{ color: "#f97316", marginTop: "4px", minWidth: "16px" }} />
                <span className={styless.allTextDigital} style={{ fontSize: "14px", lineHeight: "1.4" }}>Month-to-month engagements — no lock-ins</span>
              </div>
            </div>

            <p className={styless.allTextDigital} style={{ fontSize: "15px" }}>
        ...
        <Col xs={24} sm={24} md={12} lg={10} xl={10}>
          <div className={styless.imageContainer} style={{ position: "relative", overflow: "visible" }}>
            <Image
              ...
              style={{ borderRadius: "16px", objectFit: "cover" }}
            />
            {/* Floating Badge Fixed with proper spacing inside container */}
            {/* <div style={{ position: "absolute", bottom: "20px", right: "20px", backgroundColor: "#f97316", padding: "16px 24px", borderRadius: "12px", boxShadow: "0 10px 25px rgba(0,0,0,0.3)", zIndex: 5 }}>
